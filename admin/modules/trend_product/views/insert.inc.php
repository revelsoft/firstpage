    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?content=trend_product&action=add" enctype="multipart/form-data">
                    <div class="row">  
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>ชื่อเทรนด์สินค้า <font color="#F00"><b>*</b></font></label>
                                <input id="trend_product_title" name="trend_product_title" class="form-control"  >
                            </div>
                        </div>   
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group" >
                                ...
                                <img id="img_trend_product_img" src="../img_upload/default.png" class="img-fluid shadows hoverable"  > 
                    ...
                    <div class="row">  
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="trend_product_detail" name="trend_product_detail" class="form-control" style="min-height: 200px;"/></textarea>
                            </div>
                        </div>   
                    </div> 
