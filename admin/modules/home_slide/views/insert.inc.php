    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?content=home_slide&action=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group" >
                                ...
                                <img id="img_home_slide_img" src="../img_upload/default.png" class="img-fluid shadows hoverable"  > 
